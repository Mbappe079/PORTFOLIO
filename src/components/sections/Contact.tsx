...
export default function Contact() {
  return (
    <div
      id="contact"
      className="w-[100%] flex flex-col items-center py-[50px] max-md:px-[20px]"
    >
      <div className="w-[70%] flex justify-between items-start max-md:flex-col max-md:w-[100%] max-md:gap-y-[50px]">
        ...
        <div className="w-[49%] max-md:w-[100%]">
          <form className="p-[20px] rounded-[20px] bg-white flex flex-col gap-y-[20px] shadow shadow-gray-500 ">
            ...
            <button className="w-[100%] bg-[#2B7FFF] text-white p-[20px] rounded-[10px] flex justify-center items-center gap-x-[10px]">
              Send Message <BiSend />
            </button>
          </form>
        </div>
