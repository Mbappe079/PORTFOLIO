...
export default function Projects() {
  return (
    <div
      id="project"
      className="w-[100%] flex flex-col justify-center items-center gap-y-[40px] py-[50px] bg-[#0A0A0A] max-md:px-[20px]"
    >
      <div className="w-[100%] space-y-[50px]">
        <p className="text-[#2B7FFF] text-center font-[700] text-[50px]">
          Projects
        </p>

        <p className="text-center w-[50%] mx-auto max-md:w-[100%] text-white">
      ...
      <div className="w-[80%] flex justify-between flex-wrap gap-y-[25px] max-md:flex-col max-md:w-[100%]">
        {projectDetails.map((project, i) => (
          <div
            key={i}
            className="w-[49%] flex flex-col gap-y-[5px] overflow-hidden rounded-[20px] shadow shadow-[#2B7FFF] hover:translate-[-5px]  max-md:w-[100%]"
          >
            <div
              style={{
            ...
            <div className="w-[100%] p-[30px] space-y-[20px]">
              <p className="text-[#2B7FFF] text-[15px] font-bold">
              ...
              <a target="_blank" href={project.liveUrl}>
                <button className="flex justify-between items-center bg-[#2B7FFF] rounded-full text-white  px-[30px] py-[20px] cursor-pointer">
